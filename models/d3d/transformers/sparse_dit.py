...
from models.d3d.transformer import AbsolutePositionEmbedder
from models.d3d import sparse as sp
from models.d3d.sparse.transformer.modulated import ModulatedSparseTransformerCrossBlock
...
class SparseDiT(nn.Module):
    ...
    def forward(self, input: DiffusionInputs) -> sp.SparseTensor:
        h = self.input_layer(input.x).type(self.dtype)
        ...
        h = self.out_layer(h.type(input.x.dtype))
        return h
